...
class TestV2SerialPOS(FrappeTestCase):
    ...
    def _serial_item(self, serials=("SER-001", "SER-002")):
    ...
    def test_available_serial_endpoint_returns_only_available_item_serials(self):
        ...
        self.assertEqual(serial_numbers, {"SER-001", "SER-002"})
    ...
    def test_serial_hold_preserves_selection_and_resume_revalidates(self):
        ...
        self.assertEqual(resumed["cart_items"][0]["serial_numbers"], "SER-001")
    ...
    def test_serial_checkout_marks_sold_and_sale_cancel_restores_available(self):
        ...
        self.assertEqual(self._serial_status(item.name, "SER-001"), "Sold")
        self.assertEqual(self._serial_status(item.name, "SER-002"), "Available")
        ...
        sale.cancel()
        self.assertEqual(self._serial_status(item.name, "SER-001"), "Available")
        self.assertAlmostEqual(
            frappe.db.get_value("Ledgix Item", item.name, "current_stock"),
            2,
            places=6,
